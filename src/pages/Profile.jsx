    ...
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
        ...
        <input
          ...
          onChange={handleChange}
        />
        <button disabled={loading} className='bg-slate-700 text-white rounded-lg p-3 uppercase hover:opacity-75 disabled:opacity-80'>
          {loading ? 'Updating...' : 'Update'}
        </button>
        <Link className='bg-green-700 text-white rounded-lg p-3 uppercase hover:opacity-75 text-center' to={'/create-listing'}>
            Create Listing
        </Link>
      </form>
